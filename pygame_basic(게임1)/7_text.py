...
character_x_pos = (screen_width / 2)  - (character_width / 2)  # 화면 가로의 절반 크기에 해당하는 곳에 위치(기로)
...
enemy_x_pos = (screen_width / 2)  - (enemy_width / 2)  # 화면 가로의 절반 크기에 해당하는 곳에 위치(기로)
...
while running:
    ...
    # 20 fps : 1초 동안에 20번 동작 -> 1번에 몇 5만큼! 5 * 20 = 100
    ...
    screen.blit(character, (character_x_pos, character_y_pos))  # 캐릭커 그리기
